...
- **[Greetings messages selected randomly and sent as json]**
...
```
  git clone https://github.com/dev89/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/dev89s/hello-rails-back-end/issues).
